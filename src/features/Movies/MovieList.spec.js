...
const setStore = ({ movies }) => store.set({
    ...INITIAL_STATE,
    wasSearched: true,
    movies
});
...
describe('MovieList', () => {
    ...
    it('renders a message when a search was made and movies are returned', () => {
     ...
     it('removes select from the first clicked card when a card is clicked', async () => {
      setStore({ movies: MoviesMock.results });
